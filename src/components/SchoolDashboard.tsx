...
export default function SchoolDashboard({ 
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <TabsList 
          className="flex flex-row flex-wrap justify-center items-center gap-4 md:gap-5 p-6 md:p-8 min-h-[160px] md:min-h-[120px] bg-background/80 backdrop-blur-sm rounded-2xl border-2 border-border/50 shadow-lg w-full mb-8"
          role="tablist"
          aria-label="Seções do dashboard"
        >
          <TabsTrigger 
            value="calculator" 
            className="flex items-center justify-center gap-3 px-6 md:px-8 py-3 md:py-4 min-h-[56px] md:min-h-[64px] min-w-[140px] md:min-w-[160px] flex-grow rounded-lg transition-all duration-300 bg-card border border-border data-[state=active]:bg-primary/5 data-[state=active]:border-primary data-[state=active]:shadow-md hover:border-primary/50 hover:shadow-sm group"
          ...
          >
            ...
            <span className="text-base md:text-lg font-medium text-muted-foreground group-data-[state=active]:text-primary transition-colors">Calculadora</span>
          </TabsTrigger>
          <TabsTrigger 
            value="consumption" 
            className="flex items-center justify-center gap-3 px-6 md:px-8 py-3 md:py-4 min-h-[56px] md:min-h-[64px] min-w-[140px] md:min-w-[160px] flex-grow rounded-lg transition-all duration-300 bg-card border border-border data-[state=active]:bg-blue/5 data-[state=active]:border-blue data-[state=active]:shadow-md hover:border-blue/50 hover:shadow-sm group"
          ...
          >
            ...
            <span className="text-base md:text-lg font-medium text-muted-foreground group-data-[state=active]:text-blue transition-colors">Consumo</span>
          </TabsTrigger>
          <TabsTrigger 
            value="goals" 
            className="flex items-center justify-center gap-3 px-6 md:px-8 py-3 md:py-4 min-h-[56px] md:min-h-[64px] min-w-[140px] md:min-w-[160px] flex-grow rounded-lg transition-all duration-300 bg-card border border-border data-[state=active]:bg-accent/5 data-[state=active]:border-accent data-[state=active]:shadow-md hover:border-accent/50 hover:shadow-sm group"
          ...
          >
            ...
            <span className="text-base md:text-lg font-medium text-muted-foreground group-data-[state=active]:text-accent transition-colors">Metas</span>
          </TabsTrigger>
          <TabsTrigger 
            value="recycling-charts" 
            className="flex items-center justify-center gap-3 px-6 md:px-8 py-3 md:py-4 min-h-[56px] md:min-h-[64px] min-w-[140px] md:min-w-[160px] flex-grow rounded-lg transition-all duration-300 bg-card border border-border data-[state=active]:bg-success/5 data-[state=active]:border-success data-[state=active]:shadow-md hover:border-success/50 hover:shadow-sm group"
          ...
          >
            ...
            <span className="text-base md:text-lg font-medium text-muted-foreground group-data-[state=active]:text-success transition-colors">Reciclagem</span>
          </TabsTrigger>
          <TabsTrigger 
          ...
          >
            ...
            <span className="text-base md:text-lg font-medium text-muted-foreground group-data-[state=active]:text-primary transition-colors">Gráficos</span>
          </TabsTrigger>
          <TabsTrigger 
            value="history" 
            className="flex items-center justify-center gap-3 px-6 md:px-8 py-3 md:py-4 min-h-[56px] md:min-h-[64px] min-w-[140px] md:min-w-[160px] flex-grow rounded-lg transition-all duration-300 bg-card border border-border data-[state=active]:bg-purple/5 data-[state=active]:border-purple data-[state=active]:shadow-md hover:border-purple/50 hover:shadow-sm group"
            aria-label="Histórico"
          >
            <History className="h-5 w-5 md:h-6 md:w-6 text-muted-foreground group-data-[state=active]:text-purple transition-colors" />
            <span className="text-base md:text-lg font-medium text-muted-foreground group-data-[state=active]:text-purple transition-colors">Histórico</span>
          </TabsTrigger>
          <TabsTrigger 
            value="resources" 
            className="flex items-center justify-center gap-3 px-6 md:px-8 py-3 md:py-4 min-h-[56px] md:min-h-[64px] min-w-[140px] md:min-w-[160px] flex-grow rounded-lg transition-all duration-300 bg-card border border-border data-[state=active]:bg-success/5 data-[state=active]:border-success data-[state=active]:shadow-md hover:border-success/50 hover:shadow-sm group"
          ...
          >
            ...
            <span className="text-base md:text-lg font-medium text-muted-foreground group-data-[state=active]:text-success transition-colors">Links & Dicas</span>
          </TabsTrigger>
        </TabsList>

...
export default function SchoolDashboard({ 
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <TabsList 
          className="flex flex-col gap-3 p-4 bg-background/80 backdrop-blur-sm rounded-2xl border-2 border-border/50 shadow-lg w-full mb-8"
          role="tablist"
          aria-label="Seções do dashboard"
        >
          <TabsTrigger 
            value="calculator" 
            className="flex items-center justify-start gap-3 p-3 w-full rounded-lg transition-all duration-300 bg-card border border-border data-[state=active]:bg-primary/5 data-[state=active]:border-primary data-[state=active]:shadow-md hover:border-primary/50 hover:shadow-sm group min-h-[48px]"
          ...
          <TabsTrigger 
            value="consumption" 
            className="flex items-center justify-start gap-3 p-3 w-full rounded-lg transition-all duration-300 bg-card border border-border data-[state=active]:bg-blue/5 data-[state=active]:border-blue data-[state=active]:shadow-md hover:border-blue/50 hover:shadow-sm group min-h-[48px]"
          ...
          <TabsTrigger 
            value="goals" 
            className="flex items-center justify-start gap-3 p-3 w-full rounded-lg transition-all duration-300 bg-card border border-border data-[state=active]:bg-accent/5 data-[state=active]:border-accent data-[state=active]:shadow-md hover:border-accent/50 hover:shadow-sm group min-h-[48px]"
          ...
          <TabsTrigger 
            ...
            className="flex items-center justify-start gap-3 p-3 w-full rounded-lg transition-all duration-300 bg-card border border-border data-[state=active]:bg-success/5 data-[state=active]:border-success data-[state=active]:shadow-md hover:border-success/50 hover:shadow-sm group min-h-[48px]"
          ...
          <TabsTrigger 
            value="history" 
            className="flex items-center justify-start gap-3 p-3 w-full rounded-lg transition-all duration-300 bg-card border border-border data-[state=active]:bg-purple/5 data-[state=active]:border-purple data-[state=active]:shadow-md hover:border-purple/50 hover:shadow-sm group min-h-[48px]"
